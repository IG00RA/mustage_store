  ...
  return (
    <>
      ...
      <div className="flex mb-4 gap-4">
        ...
        >
          [UA] Mega-VIP фарм 30 дней! 2 ФП; 30 заходов! Каждый день по 20 - 30
          минут! Рандом друзей; 2FA; Много действий вне ФБ.
          Интересы.Категории[UA] Mega-VIP фарм 30 дней! 2 ФП; 30 заходов! Каждый
          день по 20 - 30 минут! Рандом друзей; 2FA; Много действий вне ФБ.
          Интересы.Категории
        </p>
      </div>
