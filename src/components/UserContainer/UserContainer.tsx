...
function getUserName(user: User): string {
  // Extract first_name and last_name from the user object
...
const UserContainer = () => {
  ...
  // Fetch initDataState using useSignal for reactive updates
  const initData = initDataState();

  // Compute userName using useMemo
  ...
  // Update tgName state when userName changes
  useEffect(() => {
    setTgName(userName);
  }, [userName]);
